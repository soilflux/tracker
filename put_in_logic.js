...
/*	PutIn_Logic.forest_boss_key = PutIn_Logic.forced_forest_boss_key;
	...
	if(Player.forest_boss_key == true) {PutIn_Logic.forest_boss_key = Location_PutIn_Logic[Location.forest_boss_key]; }
	if(Player.fire_boss_key == true) {PutIn_Logic.fire_boss_key = Location_PutIn_Logic[Location.fire_boss_key]; }
	if(Player.water_boss_key == true) {PutIn_Logic.water_boss_key = Location_PutIn_Logic[Location.water_boss_key]; }
	if(Player.spirit_boss_key == true) {PutIn_Logic.spirit_boss_key = Location_PutIn_Logic[Location.spirit_boss_key]; }
	if(Player.shadow_boss_key == true) {PutIn_Logic.shadow_boss_key = Location_PutIn_Logic[Location.shadow_boss_key]; }
	...
	if(Logic.forest_medallion_location == "deku") {if (Check.deku_queen_gohma != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.deku_queen_gohma;}
	if(Logic.forest_medallion_location == "dodongos") {if (Check.dodongos_king_dodongo != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.dodongos_king_dodongo;}
	if(Logic.forest_medallion_location == "jabu") {if (Check.jabu_barinade != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.jabu_barinade;}
	if(Logic.forest_medallion_location == "forest") {if (Check.forest_phantomGanon != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.forest_phantomGanon;}
	if(Logic.forest_medallion_location == "fire") {if (Check.fire_volvagia != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.fire_volvagia;}
	if(Logic.forest_medallion_location == "water") {if (Check.water_morpha != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.water_morpha;}
	if(Logic.forest_medallion_location == "spirit") {if (Check.spirit_twinrova != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.spirit_twinrova;}
	if(Logic.forest_medallion_location == "shadow") {if (Check.shadow_bongo != "unknown") {Player.forest = true;} PutIn_Logic.forest_medallion = Location_PutIn_Logic.shadow_bongo;}
	if(Logic.forest_medallion_location == "pocket") {Player.forest = true; PutIn_Logic.forest_medallion = true;}
	
	if(Logic.fire_medallion_location == "deku") {if (Check.deku_queen_gohma != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.deku_queen_gohma;}
	if(Logic.fire_medallion_location == "dodongos") {if (Check.dodongos_king_dodongo != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.dodongos_king_dodongo;}
	if(Logic.fire_medallion_location == "jabu") {if (Check.jabu_barinade != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.jabu_barinade;}
	if(Logic.fire_medallion_location == "forest") {if (Check.forest_phantomGanon != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.forest_phantomGanon;}
	if(Logic.fire_medallion_location == "fire") {if (Check.fire_volvagia != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.fire_volvagia;}
	if(Logic.fire_medallion_location == "water") {if (Check.water_morpha != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.water_morpha;}
	if(Logic.fire_medallion_location == "spirit") {if (Check.spirit_twinrova != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.spirit_twinrova;}
	if(Logic.fire_medallion_location == "shadow") {if (Check.shadow_bongo != "unknown") {Player.fire = true;} PutIn_Logic.fire_medallion = Location_PutIn_Logic.shadow_bongo;}
	if(Logic.fire_medallion_location == "pocket") {Player.fire = true; PutIn_Logic.fire_medallion = true;}
	
	if(Logic.water_medallion_location == "deku") {if (Check.deku_queen_gohma != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.deku_queen_gohma;}
	if(Logic.water_medallion_location == "dodongos") {if (Check.dodongos_king_dodongo != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.dodongos_king_dodongo;}
	if(Logic.water_medallion_location == "jabu") {if (Check.jabu_barinade != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.jabu_barinade;}
	if(Logic.water_medallion_location == "forest") {if (Check.forest_phantomGanon != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.forest_phantomGanon;}
	if(Logic.water_medallion_location == "fire") {if (Check.fire_volvagia != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.fire_volvagia;}
	if(Logic.water_medallion_location == "water") {if (Check.water_morpha != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.water_morpha;}
	if(Logic.water_medallion_location == "spirit") {if (Check.spirit_twinrova != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.spirit_twinrova;}
	if(Logic.water_medallion_location == "shadow") {if (Check.shadow_bongo != "unknown") {Player.water = true;} PutIn_Logic.water_medallion = Location_PutIn_Logic.shadow_bongo;}
	if(Logic.water_medallion_location == "pocket") {Player.water = true; PutIn_Logic.water_medallion = true;}
	...
	for (var i = 1; i <=3; i++) {
		...
		if(Logic[str] == "pocket") {Player[str2] = true; PutIn_Logic[str2] = true; if(document.getElementById("text_" + pocketPlacement).style.color=="rgb(238, 130, 238)") {PutIn_Logic.shadow_medallion = true;} if(document.getElementById("text_" + pocketPlacement).style.color=="rgb(255, 165, 0)") {PutIn_Logic.spirit_medallion = true;}}
	}
