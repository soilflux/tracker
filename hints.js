	...
	if (!WotHItems.includes("light_arrows")) {WotHItems.push("light_arrows");}
		...
		for (var i = 1; i <= 34; i++) {
			...
			if (woth1 == AreaNames[i] || woth2 == AreaNames[i] || woth3 == AreaNames[i] || woth4 == AreaNames[i] || woth5 == AreaNames[i]) {
				...
				if (Location.time != null && (Hinted[Location.time] == false || typeof Hinted[Location.time] == "undefined")) {if (Locations.indexOf(Location.time) == SongIndexes[i-1] || Locations.indexOf(Location.time) == SongIndexes2[i-1]) {if (WotHItems.includes("time")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Time"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.time.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("time"); }} 	 
				if (Location.storms != null && (Hinted[Location.storms] == false || typeof Hinted[Location.storms] == "undefined")) {if (Locations.indexOf(Location.storms) == SongIndexes[i-1] || Locations.indexOf(Location.storms) == SongIndexes2[i-1]) {if (WotHItems.includes("storms")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Storms"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.storms.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("storms"); }} 	 
