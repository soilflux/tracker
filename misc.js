...
function trackAnimalQuest() {
    ...
    Check["oot"] == "nocturne" && (tabPicSources[animalRNG].includes("crocodile") || tabPicSources[animalRNG].includes("elephant") || tabPicSources[animalRNG].includes("rhino")) ||
    Check["requiemSpot"] == "nocturne" && (tabPicSources[animalRNG].includes("camel"))
