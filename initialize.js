...
var areaInputs = ["kok", "kf","llr", "ran", "lon", "fie", "hf", "gv", "val", "hyl", "lh", "lak", "mkt", "mar", "hc", "cas", "out", "ogc", "tot", "zf", "fou", "ice", "dt", "dek", "lw", "mea", "sfm", "gor", "dod", "dc", "dmt", "tra", "dmc", "cra", "kv", "kak", "gy", "gra", "zr", "riv", "zd", "dom", "col", "wl", "was", "thi", "gf", "jjb", "jab", "for", "fir", "wat", "sha", "spi", "gan", "gtg", "wel", "botw"];
...
for (var i = 0; i<Locations.length; i++) {
	...
	if (i < AreaIndexes[35]) {
		var elem = document.createElement("input"); elem.id = Locations[i]; if (i < AreaIndexes[35]) {elem.style.backgroundImage = background; elem.className = "picture_input"; } else {elem.className = "check_input";} parent.appendChild(elem);
