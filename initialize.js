...
var Names = [
	"Midos", "Midos", "Midos", "Midos", "Sword", "Shop 1", "Shop 2", "Shop 3", "Shop 4", "Near Exit", "Soil", "Adult", "SoS", "Deku L", "Deku R", "Near LW", "SoS",
	...
	"Left", "Center", "Right", "Ch. Fish", "Bottle", "Soil", "Lab Wall", "Island", "Ad. Fish", "Labtop", "Crate", "Divin'", "Tree", "Sun", "Lab", "Lake R", "Lake L",
	"Guard", "Bazaar 1", "Bazaar 2", "Bazaar 3", "Bazaar 4", "Potion 1", "Potion 2", "Potion 3", "Potion 4", "Chu 1", "Chu 2", "Chu 3", "Chu 4", "Sling", "Big Rich", "Bowling", "Bowling", "Lens", "Poes", "ToT 1", "ToT 2", "ToT 3", "ToT 4",
	"Tree", "D Fairy", "Storms", "Castle 1", "Castle 2", "Castle SoS",
	"Skull", "G Fairy",
	"LACS",
	"Log", "Tree", "Fairy", "Glacier", "Divin'", "Cave", "Fairy", "Near Jabu",
	"Spinning", "Map", "HP", "HP", "Compass", "Blocks", "Irons",
	"Lobby", "Slingshot", "Slingshot", "Compass", "Compass", "Compass", "Gate", "Vines", "Basement", "Back", "Queen",
	...
	"Shop 1", "Shop 2", "Shop 3", "Shop 4", "Big Rollin'", "Dancin'", "Chuckin'", "Maze", "Maze", "Maze", "Maze!", "Center", "Lil' Rollin'", "Left", "Center", "Right", "Maze", "Medigor",
	"Keese", "Scarecrow", "Far", "Lobby", "Nook", "Vines", "Map", "Compass", "Plat", "Left", "Right", "B Bag", "Bridge", "Last", "Above", "King", "Dodongos",
	...
	"Bazaar 1", "Bazaar 2", "Bazaar 3", "Bazaar 4", "Potion 1", "Potion 2", "Potion 3", "Potion 4", "Roof", "Rear Gr", "Windmill", "Anj", "Cow", "Arch'ry", "Redead", "Cuccos", "Tree", "Guard", "Tower", "Construct", "GS House", "Impas", "Ten", "Twenty", "Thirty", "Fourty", "Fifty", "Grotto", //reasoning for skull check naming being a little weird is just because unleash animals needs enough characters to work properly(maybe not worth supporting)
	"Shield", "Box", "Race", "Race", "Tour", "Soil", "Wall", "Sun's", "Composer", "Nocturne",
	...
	"Vines", "Scrub", "Map", "Compass", "Boom", "B4 Octo L", "B4 Octo R", "Near Boss", "Barinade",
	"First", "First", "Lobby", "Stalfos", "C Mid", "C Mid", "C High", "C Low", "Shoot", "BK", "Floor", "Arch", "Red", "Bow", "Blue", "Falling", "Near Boss", "Base", "Phantom",
	"Near Boss", "Base", "Hammer", "Hammer", "Lava Open", "SoT", "Lava Bomb", "Volvagia", "Low Cell", "Bomb Wall", "Side Room", "Map", "High Cell", "Shortcut", "Crow 1", "Crow 2", "Pierre", "Compass", "SoT Goron", "MEGA",
	"Compass", "Map", "Cracked", "Torches", "S Base", "Block", "Pillar", "Pillar", "Plats", "D Link", "River", "River", "Dragin", "Near BK", "BK", "Morpha",
	"Ch. Left", "Ch. Right", "Fence", "Ch. Climb", "Ch. Climb", "Ch. Climb", "Map", "Sun Room", "B4 Knuck", "Silvers", "Ad. Left", "SoT", "Ad. Right", "Ad. Climb", "Ad. Climb", "Lulla Hand", "Lulla High", "Main Room", "4 Armos", "Invisible", "Invisible", "Mirror", "BK", "Tippy Top", "Twinrova",
	"Map", "Hovers", "Compass", "Early Silvs", "Spinning", "Spinning", "Spinning", "Crusher L", "Spikes", "Crusher H", "Crusher H", "Mid Silvs", "Pot", "Pot", "Wind", "Bombable", "Gibdos", "Near Boat", "Dins", "Dins", "3 Pots", "Floor", "Bongo",
	...
	"Lobby", "Lobby", "Stalfos", "Wolfos", "Silvers", "Silvers", "Silvers", "Silvers", "Eyes", "Abv Eyes", "Enemies", "Fire", "R1", "R2", "R3", "Beamos", "L1",  "L2", "L3", "L4", "Final", "Toilet",
	"Fake L", "F Bomb", "C Big", "Fake R", "C Small", "B Bomb", "Water L", "Coffin", "Water F", "D Hand", "Invisible", "Door L", "Door R", "Locked 1", "Locked 2", "Like Like", "Base",
