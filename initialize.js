...
var inputs = ["x", "sk", "bk", "bom", "boo", "bot", "big", "bow", "din", "far", "fir", "gor", "ham", "hoo", "hov", "iro", "len", "rut", "lig", "mag", "mir", "sca", "sli", "str", "pre", "cla", "wal", "zor", "lul", "epo", "sar", "sot", "sun", "sos", "min", "bol", "ser", "req", "noc", "pre"];
...
//document.getElementById("go_input").value = 9;
	...
	var Names = [
		...
		"Lobby L", "Lobby R", "Stalfos", "Wolfos", "Silvers 1", "Silvers 2", "Silvers 3", "Silvers 4", "Eyes", "Above", "Enemies", "Fire", "R1", "R2", "R3", "Beamos", "L1",  "L2", "L3", "L4", "Final", "Toilet",
	...
	var SongIndexes = [1000,409,419,1000,1000,1000,408,1000,417,1000,416,1000,1000,410,1000,1000,10000,413,411,412,1000,1000,415,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000];
	var SongIndexes2 = [1000,409,419,1000,1000,1000,408,1000,417,1000,416,1000,1000,414,1000,1000,1000,413,418,412,1000,1000,415,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000];
