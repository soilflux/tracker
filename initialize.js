...
var checkSummary = ["farores", "sling1", "sling2", "sling3", "boomerang", "scale1", "scale2", "rutos_letter", "bottle1", "bottle2", "bottle3", "bottle4", "bombs1", "bombs2", "bombs3", "chus1", "chus2", "chus3", "chus4", "chus5", "hammer", "bow1", "bow2", "bow3", "hookshot1", "hookshot2", "strength1", "strength2", "strength3", "mirror", "magic1", "magic2", "irons", "kokiri_sword", "hovers", "wallet1", "wallet2", "wallet3", "goron_tunic", "zora_tunic", "dins", "fire_arrows", "lens", "trade", "light_arrows", "ice_arrows", "biggoron_sword", "nayrus_love", "stone_of_agony", "forest_key_ring", "fire_key_ring", "water_key_ring", "spirit_key_ring", "shadow_key_ring", "well_key_ring", "gtg_key_ring", "ganons_key_ring", "gerudo_card", "magic_bean_pack", "text_lullabyCheck", "text_eponasCheck", "text_sariasCheck", "text_sunsCheck", "text_timeCheck", "text_stormsCheck", "text_minuetCheck", "text_boleroCheck", "text_serenadeCheck", "text_requiemCheck", "text_nocturneCheck", "text_preludeCheck"];
...
var Items = ["farores", "sling1", "sling2", "sling3", "boomerang", "scale1", "scale2", "rutos_letter", "bottle1", "bottle2", "bottle3", "bottle4", "bombs1", "bombs2", "bombs3", "chus1", "chus2", "chus3", "chus4", "chus5", "hammer", "bow1", "bow2", "bow3", "hookshot1", "hookshot2", "strength1", "strength2", "strength3", "mirror", "magic1", "magic2", "irons", "kokiri_sword", "hovers", "wallet1", "wallet2", "wallet3", "goron_tunic", "zora_tunic", "dins", "fire_arrows", "lens", "prescription", "claim_check", "light_arrows", "ice_arrows", "biggoron_sword", "nayrus_love", "stone_of_agony", "forest_key_ring", "fire_key_ring", "water_key_ring", "spirit_key_ring", "shadow_key_ring", "well_key_ring", "gtg_key_ring", "ganons_key_ring", "gerudo_card", "magic_bean_pack", "lullaby", "eponas", "suns", "sarias", "storms", "minuet", "bolero", "requiem", "nocturne", "time", "prelude", "serenade"];
...
var sometimesTableReduced = {
  ...
  "re": "requiemCheck",
  "se": "serenadeCheck",
  "k2": "tokens_20", "2": "tokens_20",
  "mp": "poes", "mb": "poes", "bi": "poes",
  "kc": "anjus_chickens", "ch": "anjus_chickens",
  "gc": "composers_grave", "cg": "composers_grave",
  "gr": "redead_grave", "rg": "redead_grave",
  "cs": "scrub_crater_child", "sc": "scrub_crater_child",
  "r1": "frogs_1", "rf": "frogs_1", "f1": "frogs_1",
  "gd": "goron_dance", "da": "goron_dance",
  "gm": "goron_maze_3", "gh": "goron_maze_3", "ma": "goron_maze_3",
  "gp": "goron_pot",
  "f2": "gerudo_archery_2", "fa": "gerudo_archery_2", "15": "gerudo_archery_2",
  "cf": "dins_fairy", "cd": "dins_fairy", "df": "dins_fairy", "ca": "dins_fairy",
  "of": "g_fairy", "og": "g_fairy",
  "fb": "bottom_of_fountain", "fi": "bottom_of_fountain", "fo": "bottom_of_fountain",
  "dk": "thaw_king", "kz": "thaw_king",
  "hd": "hylia_lab_dive", "hl": "hylia_lab_dive", "di": "hylia_lab_dive",
  "hs": "hylia_sun_shoot",
  "ls": "skull_kid", "lk": "skull_kid", "ki": "skull_kid",
  "lt": "target", "ta": "target",
  "ml": "market_lens_game", "mc": "market_lens_game", "le": "market_lens_game",
  "vr": "gerudo_hammer", "vh": "gerudo_hammer",
  "wt": "wasteland", "wa": "wasteland",
  "fh": "fire_top", "ft": "fire_top", "ff": "fire_top", "fl": "fire_top",
  "fs": "fire_scarecrow", "fp": "fire_scarecrow", "pi": "fire_scarecrow",
  "gf": "gtg_final",
  "gt": "gtg_toilet", "to": "gtg_toilet",
  "ii": "ice_irons", "ir": "ice_irons",
  "gs": "ganons_shadowTrial2", "st": "ganons_shadowTrial2",
  "jb": "jabu_boomerang", "ja": "jabu_boomerang",
  "sp": "shadow_pot",
  "sl": "spirit_leftHand", "cl": "spirit_leftHand", "lh": "spirit_leftHand",
  "sr": "spirit_rightHand", "cr": "spirit_rightHand", "rh": "spirit_rightHand",
  "wp": "water_pillar", "wc": "water_pillar", "ce": "water_pillar",
  "wb": "water_bossKey",
  "wr": "water_river", "ri": "water_river",
}
...
const inputToItemMap = {
  ...
  "fo": "forest_key_ring",
  "ff": "fire_key_ring",
  "wa": "water_key_ring", "wat": "water_key_ring",
  "sp": "spirit_key_ring",
  "sh": "shadow_key_ring",
  "we": "well_key_ring",
  "gt": "gtg_key_ring",
...
const itemToNameMap = {
  ...
  "forest_key_ring": "Forest Key Ring",
  "fire_key_ring": "Fire Key Ring",
  "water_key_ring": "Water Key Ring",
  "spirit_key_ring": "Spirit Key Ring",
  "shadow_key_ring": "Shadow Key Ring",
  "well_key_ring": "Well Key Ring",
  "gtg_key_ring": "GTG Key Ring",
  "ganons_key_ring": "Ganons Key Ring",
...
var DuplicateItems = ["sling", "scale", "bottle", "bombs", "bow", "hookshot", "strength", "magic", "wallet", "chus"];
...
for (var i = 3; i < Items2.length; i++) {
  if (Items2[i] != "chus" && Items2[i] != "sling" && Items2[i] != "bombs" && Items2[i] != "bow" && Items2[i] != "hookshot" && Items2[i] != "wallet" && Items2[i] != "strength" && Items2[i] != "bottle" && Items2[i] != "scale" && Items2[i] != "magic") {
...
var adult = [
  ...
  "goron_link",
  "gs_dodongos_east_side", "gs_dodongos_scarecrow", "scrub_dodongos_1", "scrub_dodongos_2", "dodongos_map", "dodongos_compass", "gs_dodongos_above_stairs", "gs_dodongos_stair_vines", "dodongos_bomb_flower_platform", "scrub_dodongos_3", "scrub_dodongos_4", "dodongos_bombs", "dodongos_end_of_bridge", "gs_dodongos_before_king", "dodongos_above_king", "dodongos_king_dodongo", "h_dodongos",
  "trail_fairy",
...
var checks = [
  ...
  "talons_chickens", "gs_lon_lon_tree", "eponasCheck", "back_of_ranch", "scrub_ranch_1", "scrub_ranch_2", "scrub_ranch_3", "gs_lon_lon_window", "gs_lon_lon_shed", "gs_lon_lon_back_wall", "cow_ranch1", "cow_ranch2", "cow_ranch3", "cow_ranch4",
  "hyrule_marketGrotto", "hyrule_tektite_grotto", "hyrule_hp_scrub", "hyrule_openGrotto", "hyrule_remoteGrotto", "gs_outside_kakariko", "gs_near_gerudo", "hyrule_ocarina", "cow_field", "h_hyrule_remoteGrotto", "h_hyrule_openGrotto", "h_hyrule_marketGrotto", "h_hyrule_web", "timeCheck",
  ...
  "gs_hyrule_castle_tree", "dins_fairy", "gs_hyrule_castle_grotto", "h_castle_1", "h_castle_2", "h_castle_sos", "lullabyCheck",
  "gs_ogc", "g_fairy",
  "lacs", "preludeCheck",
  ...
  "gs_ice_spinning_scythe", "ice_map", "gs_ice_hp_room", "ice_hp", "ice_compass", "gs_ice_block_room", "ice_irons", "serenadeCheck",
  ...
  "wolfos_grotto", "sariasCheck", "minuetCheck", "gs_sacred_forest", "scrub_sfm_1", "scrub_sfm_2", "h_saria", "h_sfm_1", "h_sfm_2",
  ...
  "crater_bean", "scrub_crater_1", "scrub_crater_2", "scrub_crater_3", "crater_hammer_fairy", "crater_nook_hp", "boleroCheck", "crater_grotto", "gs_crater_soil", "gs_crater_crate", "scrub_crater_child", "h_crater_grotto", "h_crater_wall",
  "tokens_10", "tokens_20", "tokens_30", "tokens_40", "tokens_50", "shop_kakariko_bazaar_TL", "shop_kakariko_bazaar_TR", "shop_kakariko_bazaar_BR", "shop_kakariko_bazaar_BL", "shop_kakariko_potion_TL", "shop_kakariko_potion_TR", "shop_kakariko_potion_BR", "shop_kakariko_potion_BL", "man_on_roof", "kakariko_grotto", "kakariko_hag", "windmill", "stormsCheck", "anju", "kakariko_cow_house", "archery_game", "redead_grotto", "anjus_chickens", "gs_kakariko_tree", "gs_kakariko_guard_house", "gs_kakariko_tower", "gs_kakariko_construction", "gs_kakariko_skulltula_house", "gs_kakariko_impas", "cow_kakariko", "h_kakariko_grotto", "nocturneCheck",
  "shield_grave", "graveyard_box", "race_1", "race_2", "sunsCheck", "gravedigging_tour", "gs_graveyard_soil", "gs_graveyard_wall", "redead_grave", "composers_grave", "h_nocturne",
  ...
  "water_compass", "water_map", "water_cracked", "water_torches", "gs_water_near_boss_key", "water_bossKey", "gs_water_south_basement", "water_block", "gs_water_central", "water_pillar", "gs_water_platform_room", "water_dLink", "gs_water_river", "water_river", "water_dragon", "water_morpha",
  "scrub_ganons_1", "scrub_ganons_2", "scrub_ganons_3", "scrub_ganons_4", "ganons_lightTrial1", "ganons_lightTrial2", "ganons_lightTrial3", "ganons_lightTrial4", "ganons_lightTrial5", "ganons_lightTrial6", "ganons_lightTrial7", "ganons_lightTrialLullaby", "ganons_spiritTrial1", "ganons_spiritTrial2", "ganons_forestTrial", "ganons_waterTrial1", "ganons_waterTrial2", "ganons_shadowTrial1", "ganons_shadowTrial2", "ganons_bossKey",
  "colossus_bean", "requiemCheck", "colossus_fairy", "gs_colossus_soil", "gs_colossus_hill", "gs_colossus_tree", "scrub_colossus_1", "scrub_colossus_2", "h_colossus",
...
var checkNames = [
  ...
  /*Ranch*/"Talon", "*Tree", "Malon", "Back", "Scrub", "Scrub", "Scrub", "*Window", "*Shed", "*Back", "Cow", "Cow", "Cow", "Cow",
  /*Field*/"Market", "Tektite", "Scrub", "Open", "Remote", "*NearKak", "*Near GV", "OoT Item", "Cow", "Remote", "Open", "Destiny", "Webs", "Song",
  ...
  /*Hyrule Castle*/"*Tree", "D Fairy", "*Storms", "Castle 1", "Castle 2", "Castle SoS", "Song",
  /*Ganon's Castle*/"*Skull", "G Fairy",
  /*Temple of Time*/"LACS", "1 Med",
  /*Fountain*/"*Log", "*Tree", "Fairy", "Glacier", "Divin", "*Cave", "Fairy", "Near Jabu",
  /*Ice*/"*Spinning", "Map Ch", "*HP", "Heart Pc", "Cmpass", "*Blocks", "Irons", "Song",
  ...
  /*Sacred Forest Meadow*/"Wolfos", "Saria", "Ad. SFM", "*Skull", "Scrub", "Scrub", "Saria", "Maze 1", "Maze 2",
  ...
  /*Crater*/"Bean", "Scrub", "Scrub", "Scrub", "Fairy", "Nook", "Song", "Grotto", "*Soil", "*Crate", "Ch. Scrub", "Grotto", "Wall",
  /*Kakariko*/"10 Tkns", "20 Tkns", "30 Tkns", "40 Tkns", "50 Tkns", "Bazaar 1", "Bazaar 2", "Bazaar 3", "Bazaar 4", "Potion 1", "Potion 2", "Potion 3", "Potion 4", "Roof", "Rear Gr", "Hag", "Windml", "Storms", "Anju's", "Cow", "Archery", "Redead", "Cuccos", "*Tree", "*Guard", "*Tower", "*Archery", "*GS house", "*Impas", "Cow Milk", "Grotto", "3 Med",
  /*Graveyard*/"Shield", "Crate", "Racing", "Racing", "Song", "Touring", "*Soil", "*Wall", "Redead", "Compo", "Nocturne",
  ...
  /*Colossus*/"Bean", "Song", "Fairy", "*Soil", "*Hill", "*Tree", "Scrub", "Scrub", "Colossus",
...
var LocationToSpoilerName = {
  ...
  "dodongos_bombs": "Dodongos Cavern Bomb Bag Chest",
...
var SpoilerLocationToLocationName = {
  ...
  "Dodongos Cavern Bomb Bag Chest": "dodongos_bombs",
...
const SpoilerItemToInput = {
  ...
  "Dins Fire": itemToInputMap["dins"],
  "Farores Wind": itemToInputMap["farores"],
  ...
  "Mirror Shield": itemToInputMap["mirror"],
  "Progressive Scale": itemToInputMap["scale"],
  "Slingshot": itemToInputMap["sling"],
  ...
  "Bombchus (10)": itemToInputMap["chus"],
  "Bombchus (20)": itemToInputMap["chus"],
  "Bombchus (5)": itemToInputMap["chus"],
...
function buildCheckSummary() {
  const itemData = [
    { id: "bombs", label: "Bomb Bag", count: 3 },
    { id: "chus", label: "Bombchus", count: 5 },
    { id: "boomerang", label: "Boomerang", count: 1 },
    { id: "bottle", label: "Bottle", count: 4 },
    { id: "bow", label: "Bow", count: 3 },
    { id: "dins", label: "Dins Fire", count: 1 },
    { id: "farores", label: "Farores", count: 1 },
    { id: "fire_arrows", label: "Fire Arrows", count: 1 },
    { id: "gerudo_card", label: "Gerudo Card", count: 1 },
    ...
    { id: "spirit_key_ring", label: "Spirit Key Ring", count: 1 },
    { id: "kokiri_sword", label: "Kokiri Sword", count: 1 },
    { id: "lens", label: "Lens", count: 1 },
    { id: "rutos_letter", label: "Letter", count: 1 },
    { id: "light_arrows", label: "Light Arrows", count: 1 },
    { id: "magic", label: "Magic", count: 2 },
    { id: "magic_bean_pack", label: "Magic Bean Pack", count: 1 },
    { id: "mirror", label: "Mirror Shield", count: 1 },
    { id: "scale", label: "Scale", count: 2 },
    { id: "sling", label: "Slingshot", count: 3 },
    { id: "strength", label: "Strength", count: 3 },
    { id: "trade", label: "Trade", count: 1 },
    { id: "wallet", label: "Wallet", count: 3 },
    { id: "zora_tunic", label: "Zora Tunic", count: 1 },
    { id: "shadow_key_ring", label: "Shadow Key Ring", count: 1 },
    { id: "well_key_ring", label: "Well Key Ring", count: 1 },
    { id: "gtg_key_ring", label: "GTG Key Ring", count: 1 },
    { id: "ganons_key_ring", label: "Ganons Key Ring", count: 1 },
    { id: "biggoron_sword", label: "BGS", count: 1 },
    { id: "nayrus_love", label: "Nayru's", count: 1 },
    { id: "stone_of_agony", label: "Agony", count: 1 }
  ];

  const container = document.getElementById('checkSummaryColumn1');
  let finalHtml = "";
  itemData.forEach(item => {
    for (let i = 1; i <= item.count; i++) {
      const uniqueBaseId = item.count > 1 ? `${item.id}${i}` : item.id;
      const fullId = `${uniqueBaseId}_location`;

      finalHtml += `
        <div id="${fullId}" class="checkSummaryText" onmousedown="toggleHint(this)">
          ${item.label} &#8594; 
        </div>`;
    }
  });
