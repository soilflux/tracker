...
for (const key of keys) {
	...
	if (document.getElementById(key).value == "lul" && !Known.lullaby) {Check[document.getElementById(key).id] = "lullaby";Location.lullaby = document.getElementById(key).id; Known.lullaby = true; if (!hinted && !peeked) {Game.lullaby = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Lullaby" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Lullaby"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "epo" && !Known.eponas) {Check[document.getElementById(key).id] = "eponas";Location.eponas = document.getElementById(key).id; Known.eponas = true; if (!hinted && !peeked) {Game.eponas = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Eponas" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Epona's"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "sar" && !Known.sarias) {Check[document.getElementById(key).id] = "sarias";Location.sarias = document.getElementById(key).id; Known.sarias = true; if (!hinted && !peeked) {Game.sarias = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Sarias" + "<br />";}var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Saria's"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "sun" && !Known.suns_song) {Check[document.getElementById(key).id] = "suns";Location.suns_song = document.getElementById(key).id; Known.suns_song = true; if (!hinted && !peeked) {Game.suns_song = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Suns" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Sun's"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "sot" && !Known.song_of_time) {Check[document.getElementById(key).id] = "sot";Location.song_of_time = document.getElementById(key).id; Known.song_of_time = true; if (!hinted && !peeked) {Game.song_of_time = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Time" + "<br />";}var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Time"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "sos" && !Known.song_of_storms) {Check[document.getElementById(key).id] = "sos"; Location.song_of_storms = document.getElementById(key).id; Known.song_of_storms = true; if (!hinted && !peeked) {Game.song_of_storms = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Storms" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Storms"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "min" && !Known.minuet) {Check[document.getElementById(key).id] = "minuet"; Location.minuet = document.getElementById(key).id; Known.minuet = true; if (!hinted && !peeked) {Game.minuet = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Minuet" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Minuet"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "bol" && !Known.bolero) {Check[document.getElementById(key).id] = "bolero";Location.bolero = document.getElementById(key).id; Known.bolero = true; if (!hinted && !peeked) {Game.bolero = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Bolero" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Bolero"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "ser" && !Known.serenade) {Check[document.getElementById(key).id] = "serenade";Location.serenade = document.getElementById(key).id; Known.serenade = true; if (!hinted && !peeked) {Game.serenade = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Serenade" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Serenade"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "req" && !Known.requiem) {Check[document.getElementById(key).id] = "requiem";Location.requiem = document.getElementById(key).id; Known.requiem = true; if (!hinted && !peeked) {Game.requiem = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Requiem" + "<br />";}var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Requiem"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "noc" && !Known.nocturne) {Check[document.getElementById(key).id] = "nocturne";Location.nocturne = document.getElementById(key).id; Known.nocturne = true; if (!hinted && !peeked) {Game.nocturne = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Nocturne" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Nocturne"; junkBS(document.getElementById(key)); continue;}
	if (document.getElementById(key).value == "pre" && !Known.prelude) {Check[document.getElementById(key).id] = "prelude";Location.prelude = document.getElementById(key).id; Known.prelude = true; if (!hinted && !peeked) {Game.prelude = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Prelude" + "<br />";} var change = "text_" + document.getElementById(key).id; backUp[temp-1] += ": Prelude"; junkBS(document.getElementById(key)); continue;}
	}
...
if (Known.bomb_bag1 && Known.bomb_bag2 && Known.bomb_bag3) {
	...
	if (Known.bow1 && Known.bow2 && Known.bow3) {
		...
		if (ChecksLockedBy.bow3.includes(Location.bow2) && ChecksLockedBy.bow3.includes(Location.bow1)) {if (!WotHItems.includes("bow")) {WotHItems.push("bow")}}
		}
	if (Logic.emerald != "unknown" && Logic.emerald != "shadow" && Logic.ruby != "shadow" && Logic.sapphire != "shadow") {if (!WotHItems.includes("dins_fire")) {WotHItems.push("dins_fire")}}
	if (Logic.emerald != "unknown" && Logic.emerald != "fire" && Logic.ruby != "fire" && Logic.sapphire != "fire") {if (!WotHItems.includes("hammer")) {WotHItems.push("hammer")}}
	if (ChecksLockedBy.hookshot1.includes(Location.hookshot2)) {if (!WotHItems.includes("hookshot1")) {WotHItems.push("hookshot1")}}
	if (ChecksLockedBy.hookshot2.includes(Location.hookshot1)) {if (!WotHItems.includes("hookshot2")) {WotHItems.push("hookshot2")}}
	if (Logic.emerald != "unknown" && Logic.emerald != "water" && Logic.ruby != "water" && Logic.sapphire != "water") {if (!WotHItems.includes("hookshot2")) {WotHItems.push("hookshot2");} if (!WotHItems.includes("hookshot1")) {WotHItems.push("hookshot1");}}
	if (Logic.emerald != "unknown" && Logic.emerald != "shadow" && Logic.ruby != "shadow" && Logic.sapphire != "shadow") {if (!WotHItems.includes("hover_boots")) {WotHItems.push("hover_boots")}}
	if (Logic.emerald != "unknown" && Logic.emerald != "water" && Logic.ruby != "water" && Logic.sapphire != "water") {if (!WotHItems.includes("iron_boots")) {WotHItems.push("iron_boots")}}
	if (Logic.emerald != "unknown" && Logic.emerald != "jabu" && Logic.ruby != "jabu" && Logic.sapphire != "jabu") {if (!WotHItems.includes("rutos_letter")) {WotHItems.push("rutos_letter")}}
	...
	if (Logic.emerald != "unknown" && Logic.emerald != "spirit" && Logic.ruby != "spirit" && Logic.sapphire != "spirit") {if (!WotHItems.includes("mirror_shield")) {WotHItems.push("mirror_shield")}}
	if (Known.slingshot1 && Known.slingshot2 && Known.slingshot3) {
		if (ChecksLockedBy.slingshot1.includes(Location.slingshot2) && ChecksLockedBy.slingshot1.includes(Location.slingshot3)) {if (!WotHItems.includes("slingshot")) {WotHItems.push("slingshot")}}
		if (ChecksLockedBy.slingshot2.includes(Location.slingshot1) && ChecksLockedBy.slingshot2.includes(Location.slingshot3)) {if (!WotHItems.includes("slingshot")) {WotHItems.push("slingshot")}}
		if (ChecksLockedBy.slingshot3.includes(Location.slingshot2) && ChecksLockedBy.slingshot3.includes(Location.slingshot1)) {if (!WotHItems.includes("slingshot")) {WotHItems.push("slingshot")}}
	}
	if (Logic.emerald != "unknown" && Logic.emerald != "forest" && Logic.ruby != "forest" && Logic.sapphire != "forest") {
		if (Known.strength1 && Known.strength3 && Known.strength2) {
			if (ChecksLockedBy.strength1.includes(Location.strength2) && ChecksLockedBy.strength1.includes(Location.strength3)) {if (!WotHItems.includes("strength1")) {WotHItems.push("strength1")}}
			if (ChecksLockedBy.strength2.includes(Location.strength1) && ChecksLockedBy.strength2.includes(Location.strength3)) {if (!WotHItems.includes("strength2")) {WotHItems.push("strength2")}}
			if (ChecksLockedBy.strength3.includes(Location.strength2) && ChecksLockedBy.strength3.includes(Location.strength1)) {if (!WotHItems.includes("strength3")) {WotHItems.push("strength3")}}
		}
	}
	if (Logic.emerald != "unknown" && Logic.emerald != "spirit" && Logic.ruby != "spirit" && Logic.sapphire != "spirit") {
		if (Known.strength1 && Known.strength2) {
			if (ChecksLockedBy.strength1.includes(Location.strength2)) {if (!WotHItems.includes("strength1")) {WotHItems.push("strength1")}}
			if (ChecksLockedBy.strength2.includes(Location.strength1)) {if (!WotHItems.includes("strength2")) {WotHItems.push("strength2")}}
		}
		if (Known.strength1 && Known.strength3) {
			if (ChecksLockedBy.strength1.includes(Location.strength3)) {if (!WotHItems.includes("strength1")) {WotHItems.push("strength1")}}
			if (ChecksLockedBy.strength3.includes(Location.strength1)) {if (!WotHItems.includes("strength3")) {WotHItems.push("strength3")}}
		}
		if (Known.strength2 && Known.strength3) {
			if (ChecksLockedBy.strength3.includes(Location.strength2)) {if (!WotHItems.includes("strength3")) {WotHItems.push("strength3")}}
			if (ChecksLockedBy.strength2.includes(Location.strength3)) {if (!WotHItems.includes("strength2")) {WotHItems.push("strength2")}}
		}
	}
	if (Logic.emerald != "unknown" && Logic.emerald != "shadow" && Logic.ruby != "shadow" && Logic.sapphire != "shadow") {if (!WotHItems.includes("lullaby")) {WotHItems.push("lullaby")}}
	if (Logic.emerald != "unknown" && Logic.emerald != "shadow" && Logic.ruby != "shadow" && Logic.sapphire != "shadow") {if (!WotHItems.includes("nocturne")) {WotHItems.push("nocturne")}}
	...
	for (var i = 1; i <= 34; i++) {
		...
		if (woth1 == AreaNames[i] || woth2 == AreaNames[i] || woth3 == AreaNames[i] || woth4 == AreaNames[i] || woth5 == AreaNames[i]) {
			...
			if (Location.slingshot1 != null && Hinted[Location.slingshot1] == false || typeof Hinted[Location.slingshot1] == "undefined") {if (Locations.indexOf(Location.slingshot1) >= AreaIndexes[i-1] && Locations.indexOf(Location.slingshot1) < AreaIndexes[i]) {if (Location.slingshot2 != null && !ChecksPutInLogicBy.slingshot1.includes(Location.slingshot2)){} else if (Location.slingshot3 != null && !ChecksPutInLogicBy.slingshot1.includes(Location.slingshot3)) {} else {if (WotHItems.includes("slingshot1")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Slingshot"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.slingshot1.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("slingshot1"); }}} 	
			if (Location.slingshot2 != null && Hinted[Location.slingshot2] == false || typeof Hinted[Location.slingshot2] == "undefined") {if (Locations.indexOf(Location.slingshot2) >= AreaIndexes[i-1] && Locations.indexOf(Location.slingshot2) < AreaIndexes[i]) {if (Location.slingshot3 != null && !ChecksPutInLogicBy.slingshot2.includes(Location.slingshot3)){} else if (Location.slingshot1 != null && !ChecksPutInLogicBy.slingshot2.includes(Location.slingshot1)) {} else {if (WotHItems.includes("slingshot2")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Slingshot"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.slingshot2.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("slingshot2"); }}} 	
			if (Location.slingshot3 != null && Hinted[Location.slingshot3] == false || typeof Hinted[Location.slingshot3] == "undefined") {if (Locations.indexOf(Location.slingshot3) >= AreaIndexes[i-1] && Locations.indexOf(Location.slingshot3) < AreaIndexes[i]) {if (Location.slingshot1 != null && !ChecksPutInLogicBy.slingshot3.includes(Location.slingshot1)){} else if (Location.slingshot2 != null && !ChecksPutInLogicBy.slingshot3.includes(Location.slingshot2)) {} else {if (WotHItems.includes("slingshot3")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Slingshot"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.slingshot3.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("slingshot3"); }}} 	
			...
			if (Location.bomb_bag1 != null && Hinted[Location.bomb_bag1] == false || typeof Hinted[Location.bomb_bag1] == "undefined") {if (Locations.indexOf(Location.bomb_bag1) >= AreaIndexes[i-1] && Locations.indexOf(Location.bomb_bag1) < AreaIndexes[i]) {if (Location.bomb_bag2 != null && !ChecksPutInLogicBy.bomb_bag1.includes(Location.bomb_bag2)){} else if (Location.bomb_bag3 != null && !ChecksPutInLogicBy.bomb_bag1.includes(Location.bomb_bag3)) {} else {if (WotHItems.includes("bomb_bag1")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Bomb Bag"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.bomb_bag1.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("bomb_bag1"); }}} 	
			if (Location.bomb_bag2 != null && Hinted[Location.bomb_bag2] == false || typeof Hinted[Location.bomb_bag2] == "undefined") {if (Locations.indexOf(Location.bomb_bag2) >= AreaIndexes[i-1] && Locations.indexOf(Location.bomb_bag2) < AreaIndexes[i]) {if (Location.bomb_bag3 != null && !ChecksPutInLogicBy.bomb_bag2.includes(Location.bomb_bag3)){} else if (Location.bomb_bag1 != null && !ChecksPutInLogicBy.bomb_bag2.includes(Location.bomb_bag1)) {} else {if (WotHItems.includes("bomb_bag2")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Bomb Bag"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.bomb_bag2.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("bomb_bag2"); }}} 	
			if (Location.bomb_bag3 != null && Hinted[Location.bomb_bag3] == false || typeof Hinted[Location.bomb_bag3] == "undefined") {if (Locations.indexOf(Location.bomb_bag3) >= AreaIndexes[i-1] && Locations.indexOf(Location.bomb_bag3) < AreaIndexes[i]) {if (Location.bomb_bag1 != null && !ChecksPutInLogicBy.bomb_bag3.includes(Location.bomb_bag1)){} else if (Location.bomb_bag2 != null && !ChecksPutInLogicBy.bomb_bag3.includes(Location.bomb_bag2)) {} else {if (WotHItems.includes("bomb_bag3")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Bomb Bag"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.bomb_bag3.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("bomb_bag3"); }}} 	
			if (Location.bow1 != null && Hinted[Location.bow1] == false || typeof Hinted[Location.bow1] == "undefined") {if (Locations.indexOf(Location.bow1) >= AreaIndexes[i-1] && Locations.indexOf(Location.bow1) < AreaIndexes[i]) {if (Location.bow2 != null && !ChecksPutInLogicBy.bow1.includes(Location.bow2)){} else if (Location.bow3 != null && !ChecksPutInLogicBy.bow1.includes(Location.bow3)) {} else {if (WotHItems.includes("bow1")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Bow"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.bow1.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("bow1"); }}} 	
			if (Location.bow2 != null && Hinted[Location.bow2] == false || typeof Hinted[Location.bow2] == "undefined") {if (Locations.indexOf(Location.bow2) >= AreaIndexes[i-1] && Locations.indexOf(Location.bow2) < AreaIndexes[i]) {if (Location.bow3 != null && !ChecksPutInLogicBy.bow2.includes(Location.bow3)){} else if (Location.bow1 != null && !ChecksPutInLogicBy.bow2.includes(Location.bow1)) {} else {if (WotHItems.includes("bow2")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Bow"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.bow2.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("bow2"); }}} 	
			if (Location.bow3 != null && Hinted[Location.bow3] == false || typeof Hinted[Location.bow3] == "undefined") {if (Locations.indexOf(Location.bow3) >= AreaIndexes[i-1] && Locations.indexOf(Location.bow3) < AreaIndexes[i]) {if (Location.bow1 != null && !ChecksPutInLogicBy.bow3.includes(Location.bow1)){} else if (Location.bow2 != null && !ChecksPutInLogicBy.bow3.includes(Location.bow2)) {} else {if (WotHItems.includes("bow3")) {document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).className = "woth_item_text"; tempnumber3 +=1;} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML = "Bow"; for (var j = 0; j < Items.length; j++) {if (ChecksLockedBy.bow3.includes(Location[Items[j]])){document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += ", " + ItemNames[j];}} document.getElementById("woth" + tempnumber2 + "_text" + tempnumber1).innerHTML += " <br />"; tempnumber1 += 1; tempArray.push("bow3"); }}} 	
