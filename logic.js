...
function logicShortcuts() {
	...
	Player.can_enter_jabu = Player.child_can_enter_domain && Player.rutos_letter;
	...
	CouldHave.can_enter_jabu = CouldHave.child_can_enter_domain && CouldHave.rutos_letter;
	...
	CouldHave.middle_water = CouldHave.can_do_water_checks && CouldHave.lullaby && (CouldHave.bow || CouldHave.can_use_dins || CouldHave.current_water_keys >= 1);
...
function locationLogic(){
	...
	Location_Could_Access.forest_midCourtyard = CouldHave.can_enter_forest_temple && ((((CouldHave.time || CouldHave.bow || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys>=1)) && CouldHave.hookshot)) || (CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5));
	Location_Could_Access.forest_highCourtyard = CouldHave.can_enter_forest_temple && (CouldHave.time || (CouldHave.bow && CouldHave.hookshot) || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys>=1) || (CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5));
	Location_Could_Access.forest_lowCourtyard = CouldHave.can_enter_forest_temple && (CouldHave.time || (CouldHave.bow && CouldHave.hookshot) || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys>=1) || (CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5));
	Location_Could_Access.forest_blockRoom = CouldHave.can_enter_forest_temple && CouldHave.current_forest_keys >= 1 && CouldHave.bow && CouldHave.goron_bracelet;
	Location_Could_Access.forest_bossKey = CouldHave.can_enter_forest_temple && CouldHave.current_forest_keys >= 2 && CouldHave.bow && CouldHave.goron_bracelet;
	Location_Could_Access.forest_floormaster = CouldHave.can_enter_forest_temple && ((CouldHave.bow && CouldHave.goron_bracelet && CouldHave.current_forest_keys >=2) || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys >=1));
	Location_Could_Access.forest_red = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=3;
	Location_Could_Access.forest_bow = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.current_forest_keys>=3;
	Location_Could_Access.forest_blue = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=3;
	Location_Could_Access.forest_fallingCeiling = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5;
	Location_Could_Access.forest_nearBoss = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=5;
	Location_Could_Access.forest_phantomGanon = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=5 && CouldHave.forest_boss_key;
	...
	Location_Could_Access.water_dLink = CouldHave.current_water_keys >= 2 && CouldHave.hookshot;
	Location_Could_Access.water_river = CouldHave.current_water_keys >= 2 && CouldHave.time && CouldHave.bow && CouldHave.hookshot;
	Location_Could_Access.water_dragon = CouldHave.can_do_water_checks && ((CouldHave.current_water_keys >= 2 && CouldHave.hookshot && CouldHave.time && CouldHave.bow) || (CouldHave.goron_bracelet && CouldHave.lullaby && ((CouldHave.iron_boots && CouldHave.hookshot) || Player.has_chus || CouldHave.bomb_bag) && (CouldHave.silver_scale || CouldHave.iron_boots)));
	Location_Could_Access.water_bossKey = CouldHave.can_do_water_checks && (CouldHave.lullaby || CouldHave.iron_boots) && (CouldHave.longshot || CouldHave.hover_boots) && CouldHave.current_water_keys >= 2;
	...
	Location_Could_Access.well_locked1 = CouldHave.can_enter_well && CouldHave.current_well_keys >= 1;//&& CouldHave.can_see ;
	Location_Could_Access.well_locked2 = CouldHave.can_enter_well && CouldHave.current_well_keys >= 1;//&& CouldHave.can_see ;
	Location_Could_Access.well_basement = CouldHave.can_enter_well && ((CouldHave.bomb_bag || Player.has_chus) || (((/*CouldHave.can_see &&*/ CouldHave.current_well_keys >= 1) || CouldHave.can_use_dins) && CouldHave.goron_bracelet));
	...
	Location_Could_Peek.forest_midCourtyard = CouldHave.can_enter_forest_temple && ((((CouldHave.time || CouldHave.bow || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys>=1)) && CouldHave.hookshot)) || (CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5));
	Location_Could_Peek.forest_highCourtyard = CouldHave.can_enter_forest_temple && (CouldHave.time || (CouldHave.bow && CouldHave.hookshot) || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys>=1) || (CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5));
	Location_Could_Peek.forest_lowCourtyard = CouldHave.can_enter_forest_temple && (CouldHave.time || (CouldHave.bow && CouldHave.hookshot) || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys>=1) || (CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5));
	Location_Could_Peek.forest_blockRoom = CouldHave.can_enter_forest_temple && CouldHave.current_forest_keys >= 1 && CouldHave.bow && CouldHave.goron_bracelet;
	Location_Could_Peek.forest_bossKey = CouldHave.can_enter_forest_temple && CouldHave.current_forest_keys >= 2 && CouldHave.bow && CouldHave.goron_bracelet;
	Location_Could_Peek.forest_floormaster = CouldHave.can_enter_forest_temple && ((CouldHave.bow && CouldHave.goron_bracelet && CouldHave.current_forest_keys >=2) || ((CouldHave.hover_boots || CouldHave.goron_bracelet) && CouldHave.current_forest_keys >=1));
	Location_Could_Peek.forest_red = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=3;
	Location_Could_Peek.forest_bow = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.current_forest_keys>=3;
	Location_Could_Peek.forest_blue = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=3;
	Location_Could_Peek.forest_fallingCeiling = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && (CouldHave.bow || CouldHave.can_use_dins) && CouldHave.current_forest_keys>=5;
	Location_Could_Peek.forest_nearBoss = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=5;
	Location_Could_Peek.forest_phantomGanon = CouldHave.can_enter_forest_temple && CouldHave.goron_bracelet && CouldHave.bow && CouldHave.current_forest_keys>=5 && CouldHave.forest_boss_key;
	...
	Location_Could_Peek.water_dLink = CouldHave.current_water_keys >= 2 && CouldHave.hookshot;
	Location_Could_Peek.water_river = CouldHave.current_water_keys >= 2 && CouldHave.time && CouldHave.bow && CouldHave.hookshot;
	Location_Could_Peek.water_dragon = ((CouldHave.current_water_keys >= 2 && CouldHave.hookshot && CouldHave.time && CouldHave.bow) || (CouldHave.goron_bracelet && CouldHave.lullaby && ((CouldHave.iron_boots && CouldHave.hookshot) || Player.has_chus || CouldHave.bomb_bag) && (CouldHave.silver_scale || CouldHave.iron_boots)));
	Location_Could_Peek.water_bossKey = CouldHave.can_do_water_checks && (CouldHave.lullaby || CouldHave.iron_boots) && (CouldHave.longshot || CouldHave.hover_boots) && CouldHave.current_water_keys >= 2;
	...
	Location_Could_Peek.well_locked1 = CouldHave.can_enter_well && CouldHave.current_well_keys >= 1;//&& CouldHave.can_see ;
	Location_Could_Peek.well_locked2 = CouldHave.can_enter_well && CouldHave.current_well_keys >= 1;//&& CouldHave.can_see ;
	Location_Could_Peek.well_basement = CouldHave.can_enter_well && ((CouldHave.bomb_bag || Player.has_chus) || (((/*CouldHave.can_see &&*/ CouldHave.current_well_keys >= 1) || CouldHave.can_use_dins) && CouldHave.goron_bracelet));
	...
	if(document.getElementById("csmc").value == "ON") {
		...
		Location_Could_Peek.forest_blockRoom = CouldHave.can_enter_forest_temple && CouldHave.current_forest_keys >= 1 && CouldHave.bow;
		...
		Location_Could_Peek.water_river = CouldHave.current_water_keys >= 2 && CouldHave.time && Player.hookshot;
