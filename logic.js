...
function updateLocationLogic() {
  ...
  locationLogic.sunsCheck = logic.lullaby;
  locationLogic.boleroCheck = logic.can_enter_fire_temple_entrance;
  locationLogic.minuetCheck = logic.can_pass_mido_as_adult;
  locationLogic.requiemCheck = logic.can_enter_colossus;
  locationLogic.serenadeCheck = logic.ice_access && (logic.bottle || logic.can_shoot_blue_fire_arrows) && (logic.ice_adult_access || logic.giants_wallet);
  locationLogic.preludeCheck = logic.forest_medallion;
  locationLogic.nocturneCheck = logic.forest_medallion && logic.fire_medallion && logic.water_medallion;
