...
function logic_shortcuts() {
	...
	Game.can_beat_shadow_boss = Game.can_ride_shadow_boat && (Game.bow1 || Game.longshot || Game.has_chus);
...
function location_logic(){
	...
	Location_Access.goron_pot = (Game.bomb_bag1 || Game.goron_bracelet || Game.has_chus) && (Game.lullaby || Game.can_use_dins || Spawn.child_lower_dmc);
