...
function spawn_inputs() {
	...
	if (document.getElementById("markChildLocation").value.toLowerCase() == spawnInputs[spawnNames.indexOf("trail fairy(ool)")].toLowerCase()) {Spawn.child_upper_dmc = true; Spawn.child_upper_dmc_fairy = true; Spawn.child_upper_dmc_fairy_ool = true;} else {Spawn.child_upper_dmc_fairy = false;  Spawn.child_upper_dmc_fairy_ool = false;}
	...
	if (document.getElementById("markChildLocation").value.toLowerCase() == spawnInputs[spawnNames.indexOf("trail fairy(ool)")].toLowerCase()) {Spawn.adult_upper_dmc = true; Spawn.adult_upper_dmc_fairy = true; Spawn.adult_upper_dmc_fairy_ool = true;} else {Spawn.adult_upper_dmc_fairy = false;  Spawn.adult_upper_dmc_fairy_ool = false;}
...
function update_logic_info() {
	if (document.getElementById("presets").value == "LESS_PROGRESSION") {Rules.kzSkip = false; document.getElementById("bosskeys").value = "REMOVE"; document.getElementById("shuffleOcarinas").value = "OFF"; document.getElementById("ganonsBridge").value = "ALL_MED"; document.getElementById("closedDeku").value = "CLOSED"; document.getElementById("ganonBKSetting").value = "NONE"; document.getElementById("woth_input5").style.display = "inline-block"; document.getElementById("barren_input3").style.display = "inline-block";}
	...
	if (document.getElementById("presets").value == "WEEKLY") {Rules.kzSkip = true; document.getElementById("bosskeys").value = "DUNGEON_ONLY"; document.getElementById("shuffleOcarinas").value = "OFF"; document.getElementById("ganonsBridge").value = "4_MEDALS"; document.getElementById("closedDeku").value = "OPEN"; document.getElementById("ganonBKSetting").value = "NONE"; document.getElementById("woth_input5").style.display = "inline-block"; document.getElementById("barren_input3").style.display = "inline-block";}
