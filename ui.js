...
function update_logic_info() {
	...
	if (document.getElementById("presets").value == "S5") {Rules.kzSkip = false;  document.getElementById("bosskeys").value = "DUNGEON_ONLY"; document.getElementById("shuffleOcarinas").value = "OFF"; document.getElementById("ganonsBridge").value = "ALL_MED"; document.getElementById("closedDeku").value = "CLOSED"; document.getElementById("ganonBKSetting").value = "NONE";document.getElementById("path_hints_div").style.display = "block";}
