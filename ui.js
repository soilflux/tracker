...
function updateChecklistRewards() {
  ...
  rewardList.forEach((rewardName, index) => {
    ...
    if (dungeonName && validDungeons.has(dungeonName)) {
      ...
      if (element) {
        element.src = getImagePath(rewardName);
  ...
  if (rules.linso == "show") {
    ...
    for (var i = 1; i <= 11; i++) {
      for (var j = 1; j <= 6; j++) {
        ...
        if (linsoOrder[temp] == "hookshot") { if (player.hookshot && !player.longshot) { document.getElementById("linso" + i + j).src = getImagePath("hookshot"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else if (player.longshot) { document.getElementById("linso" + i + j).src = getImagePath("longshot"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else { document.getElementById("linso" + i + j).src = getImagePath("hookshot"); document.getElementById("linso" + i + j).style.filter = "grayscale(100%)"; document.getElementById("linso" + i + j).style.opacity = dimmed; } }
        else if (linsoOrder[temp] == "silver_scale") { if (player.silver_scale && !player.golden_scale) { document.getElementById("linso" + i + j).src = getImagePath("silver_scale"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else if (player.golden_scale) { document.getElementById("linso" + i + j).src = getImagePath("golden_scale"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else { document.getElementById("linso" + i + j).src = getImagePath("silver_scale"); document.getElementById("linso" + i + j).style.filter = "grayscale(100%)"; document.getElementById("linso" + i + j).style.opacity = dimmed; } }
        else if (linsoOrder[temp] == "adults_wallet") { if (player.tycoon_wallet) { document.getElementById("linso103").style.opacity = 1; } else { document.getElementById("linso103").style.opacity = 0; } if (player.giants_wallet) { document.getElementById("linso" + i + j).src = getImagePath("wallet2"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else if (player.adults_wallet) { document.getElementById("linso" + i + j).src = getImagePath("wallet1"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else { document.getElementById("linso" + i + j).src = getImagePath("wallet1"); document.getElementById("linso" + i + j).style.filter = "grayscale(100%)"; document.getElementById("linso" + i + j).style.opacity = dimmed; } }
        else if (linsoOrder[temp] == "goron_bracelet") { if (player.golden_gauntlets) { document.getElementById("linso" + i + j).src = getImagePath("golden_gauntlets"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else if (player.silver_gauntlets) { document.getElementById("linso" + i + j).src = getImagePath("silver_gauntlets"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else if (player.goron_bracelet) { document.getElementById("linso" + i + j).src = getImagePath("goron_bracelet"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; } else { document.getElementById("linso" + i + j).src = getImagePath("goron_bracelet"); document.getElementById("linso" + i + j).style.filter = "grayscale(100%)"; document.getElementById("linso" + i + j).style.opacity = dimmed; } }
        else if (linsoOrder[temp] == "egg1" && player.claim_check) { document.getElementById("linso" + i + j).src = getImagePath("claim_check"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; }
        ...
        else if (linsoOrder[temp] == "egg1" && player.prescription) { document.getElementById("linso" + i + j).src = getImagePath("prescription"); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1; }
