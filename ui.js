				...
				for (var k = 0; k <= 3; k++) {
					...
					if (!Known[Items2[j] + duplicate]) {
						if (i <= lastItem) {
							...
							if (Items2[j] == "prescription" || Items2[j] == "claim_check") {document.getElementById("trade_location").innerHTML = ItemNames2[j] + " -> " + AreaNames[AreaNamesIndex] + ": " + Names[i];} else {document.getElementById(Items2[j] + duplicate + "_location").innerHTML = ItemNames2[j] + " -> " + AreaNames[AreaNamesIndex] + ": " + Names[i];}
