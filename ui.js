function process_inputs() {
	...
	for (var i = 0; i < Locations.length; i++) {
		...
		if (document.getElementById(key).value == "far" && !Known.farores_wind) {Check[document.getElementById(key).id] = "farores_wind"; Location.farores_wind = document.getElementById(key).id; document.getElementById("farores_wind_location").innerHTML = "Farores -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.farores_wind = true; if (!hinted && !peeked) {Game.farores_wind = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Farores" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "sli" && !Known.slingshot1) {Check[document.getElementById(key).id] = "slingshot1"; Location.slingshot1 = document.getElementById(key).id; document.getElementById("slingshot1_location").innerHTML = "Slingshot -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.slingshot1 = true; if (!hinted && !peeked) {Game.slingshot1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Slingshot" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "sli" && !Known.slingshot2) {Check[document.getElementById(key).id] = "slingshot2"; Location.slingshot2 = document.getElementById(key).id; document.getElementById("slingshot2_location").innerHTML = "Slingshot -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.slingshot2 = true; if (!hinted && !peeked) {Game.slingshot2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Slingshot" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "sli" && !Known.slingshot3) {Check[document.getElementById(key).id] = "slingshot3";Location.slingshot3 = document.getElementById(key).id; document.getElementById("slingshot3_location").innerHTML = "Slingshot -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.slingshot3 = true; if (!hinted && !peeked) {Game.slingshot3 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Slingshot" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "boo" && !Known.boomerang) {Check[document.getElementById(key).id] = "boomerang"; Location.boomerang = document.getElementById(key).id; document.getElementById("boomerang_location").innerHTML = "Boomerang -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.boomerang = true; if (!hinted && !peeked) {Game.boomerang = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Boomerang" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "sca" && !Known.scale1) {Check[document.getElementById(key).id] = "scale1"; Location.scale1 = document.getElementById(key).id; document.getElementById("scale1_location").innerHTML = "Scale -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.scale1 = true; if (!hinted && !peeked) {Game.scale1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Scale" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "sca" && !Known.scale2) {Check[document.getElementById(key).id] = "scale2";Location.scale2 = document.getElementById(key).id; document.getElementById("scale2_location").innerHTML = "Scale -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.scale2 = true; if (!hinted && !peeked) {Game.scale2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Scale" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "rut" && !Known.rutos_letter) {Check[document.getElementById(key).id] = "rutos_letter"; Location.rutos_letter = document.getElementById(key).id; document.getElementById("rutos_letter_location").innerHTML = "Letter -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.rutos_letter = true; if (!hinted && !peeked) {Game.rutos_letter = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Letter" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "bot" && !Known.bottle1) {Check[document.getElementById(key).id] = "bottle1"; Location.bottle1 = document.getElementById(key).id; document.getElementById("bottle1_location").innerHTML = "Bottle -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bottle1 = true; if (!hinted && !peeked) {Game.bottle1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bottle" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "bot" && !Known.bottle2) {Check[document.getElementById(key).id] = "bottle2"; Location.bottle2 = document.getElementById(key).id; document.getElementById("bottle2_location").innerHTML = "Bottle -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bottle2 = true; if (!hinted && !peeked) {Game.bottle2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bottle" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "bot" && !Known.bottle3) {Check[document.getElementById(key).id] = "bottle3"; Location.bottle3 = document.getElementById(key).id; document.getElementById("bottle3_location").innerHTML = "Bottle -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bottle3 = true; if (!hinted && !peeked) {Game.bottle3 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bottle" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "big" && !Known.bottle1) {Check[document.getElementById(key).id] = "big_poe";Location.bottle1 = document.getElementById(key).id; Location.big1= document.getElementById(key).id; document.getElementById("bottle1_location").innerHTML = "Big Poe -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bottle1 = true; Known.big_poe = true; if (!hinted && !peeked) {Game.bottle1 = true; Game.big_poe = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Big Poe" + "<br />";} junkItem(document.getElementById(key)); continue;}
		...
		if (document.getElementById(key).value == "bom" && !Known.bomb_bag1) {Check[document.getElementById(key).id] = "bomb_bag1"; Location.bomb_bag1 = document.getElementById(key).id; document.getElementById("bomb_bag1_location").innerHTML = "Bomb Bag -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bomb_bag1 = true; if (!hinted && !peeked) {Game.bomb_bag1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bomb Bag" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "bom" && !Known.bomb_bag2) {Check[document.getElementById(key).id] = "bomb_bag2"; Location.bomb_bag2 = document.getElementById(key).id; document.getElementById("bomb_bag2_location").innerHTML = "Bomb Bag -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bomb_bag2 = true; if (!hinted && !peeked) {Game.bomb_bag2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bomb Bag" + "<br />";} junkItem(document.getElementById(key));continue;}
		else if (document.getElementById(key).value == "bom" && !Known.bomb_bag3) {Check[document.getElementById(key).id] = "bomb_bag3"; Location.bomb_bag3 = document.getElementById(key).id; document.getElementById("bomb_bag3_location").innerHTML = "Bomb Bag -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bomb_bag3 = true; if (!hinted && !peeked) {Game.bomb_bag3 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bomb Bag" + "<br />";} junkItem(document.getElementById(key));continue;}
		
		if (document.getElementById(key).value == "ham" && !Known.hammer) {Check[document.getElementById(key).id] = "hammer"; Location.hammer = document.getElementById(key).id; document.getElementById("hammer_location").innerHTML = "Hammer -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.hammer = true; if (!hinted && !peeked) {Game.hammer = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Hammer" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "bow" && !Known.bow1) {Check[document.getElementById(key).id] = "bow1"; Location.bow1 = document.getElementById(key).id; document.getElementById("bow1_location").innerHTML = "Bow -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bow1 = true; if (!hinted && !peeked) {Game.bow1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bow" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "bow" && !Known.bow2) {Check[document.getElementById(key).id] = "bow2"; Location.bow2 = document.getElementById(key).id; document.getElementById("bow2_location").innerHTML = "Bow -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bow2 = true; if (!hinted && !peeked) {Game.bow2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bow" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "bow" && !Known.bow3) {Check[document.getElementById(key).id] = "bow3";Location.bow3 = document.getElementById(key).id; document.getElementById("bow3_location").innerHTML = "Bow -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.bow3 = true; if (!hinted && !peeked) {Game.bow3 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Bow" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "hoo" && !Known.hookshot1) {Check[document.getElementById(key).id] = "hookshot1";Location.hookshot1 = document.getElementById(key).id; document.getElementById("hookshot1_location").innerHTML = "Hookshot -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.hookshot1 = true; if (!hinted && !peeked) {Game.hookshot1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Hookshot" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "hoo" && !Known.hookshot2) {Check[document.getElementById(key).id] = "hookshot2";Location.hookshot2 = document.getElementById(key).id; document.getElementById("hookshot2_location").innerHTML = "Hookshot -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.hookshot2 = true; if (!hinted && !peeked) {Game.hookshot2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Hookshot" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "str" && !Known.strength1) {Check[document.getElementById(key).id] = "strength1"; Location.strength1 = document.getElementById(key).id; document.getElementById("strength1_location").innerHTML = "Strength -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.strength1 = true; if (!hinted && !peeked) {Game.strength1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Strength" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "str" && !Known.strength2) {Check[document.getElementById(key).id] = "strength2"; Location.strength2 = document.getElementById(key).id; document.getElementById("strength2_location").innerHTML = "Strength -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.strength2 = true; if (!hinted && !peeked) {Game.strength2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Strength" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "str" && !Known.strength3) {Check[document.getElementById(key).id] = "strength3";Location.strength3 = document.getElementById(key).id; document.getElementById("strength3_location").innerHTML = "Strength -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.strength3 = true; if (!hinted && !peeked) {Game.strength3 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Strength" + "<br />";}junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "mir" && !Known.mirror_shield) {Check[document.getElementById(key).id] = "mirror_shield"; Location.mirror_shield = document.getElementById(key).id; document.getElementById("mirror_shield_location").innerHTML = "Mirror Shield -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.mirror_shield = true; if (!hinted && !peeked) {Game.mirror_shield = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Mirror Shield" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "mag" && !Known.magic1) {Check[document.getElementById(key).id] = "magic1"; Location.magic1 = document.getElementById(key).id; document.getElementById("magic1_location").innerHTML = "Magic -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.magic1 = true; if (!hinted && !peeked) {Game.magic1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Magic" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "mag" && !Known.magic2) {Check[document.getElementById(key).id] = "magic2"; Location.magic2 = document.getElementById(key).id; document.getElementById("magic2_location").innerHTML = "Magic -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.magic2 = true; if (!hinted && !peeked) {Game.magic2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Magic" + "<br />";}junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "iro" && !Known.iron_boots) {Check[document.getElementById(key).id] = "iron_boots";Location.iron_boots = document.getElementById(key).id; document.getElementById("iron_boots_location").innerHTML = "Iron Boots -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.iron_boots = true; if (!hinted && !peeked) {Game.iron_boots = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Iron Boots" + "<br />";} junkItem(document.getElementById(key)); continue;}
		if (document.getElementById(key).value == "hov" && !Known.hover_boots) {Check[document.getElementById(key).id] = "hover_boots";Location.hover_boots = document.getElementById(key).id; document.getElementById("hover_boots_location").innerHTML = "Hover Boots -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.hover_boots = true; if (!hinted && !peeked) {Game.hover_boots = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Hover Boots" + "<br />";}junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "wal" && !Known.wallet1) {Check[document.getElementById(key).id] = "wallet1";Location.wallet1 = document.getElementById(key).id; document.getElementById("wallet1_location").innerHTML = "Wallet -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.wallet1 = true; if (!hinted && !peeked) {Game.wallet1 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Wallet" + "<br />";} junkItem(document.getElementById(key)); continue;}
		else if (document.getElementById(key).value == "wal" && !Known.wallet2) {Check[document.getElementById(key).id] = "wallet2";Location.wallet2 = document.getElementById(key).id; document.getElementById("wallet2_location").innerHTML = "Wallet -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.wallet2 = true; if (!hinted && !peeked) {Game.wallet2 = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Wallet" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "gor" && !Known.goron_tunic) {Check[document.getElementById(key).id] = "goron_tunic";Location.goron_tunic = document.getElementById(key).id; document.getElementById("goron_tunic_location").innerHTML = "Goron Tunic -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.goron_tunic = true; if (!hinted && !peeked) {Game.goron_tunic = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Goron Tunic" + "<br />";} junkItem(document.getElementById(key)); continue;}
		if (document.getElementById(key).value == "zor" && !Known.zora_tunic) {Check[document.getElementById(key).id] = "zora_tunic";Location.zora_tunic = document.getElementById(key).id; document.getElementById("zora_tunic_location").innerHTML = "Zora Tunic -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.zora_tunic = true; if (!hinted && !peeked) {Game.zora_tunic = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Zora Tunic" + "<br />";}junkItem(document.getElementById(key)); continue;}
		if (document.getElementById(key).value == "din" && !Known.dins_fire) {Check[document.getElementById(key).id] = "dins_fire";Location.dins_fire = document.getElementById(key).id; document.getElementById("dins_fire_location").innerHTML = "Dins Fire -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.dins_fire = true; if (!hinted && !peeked) {Game.dins_fire = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Din's Fire" + "<br />";} junkItem(document.getElementById(key)); continue;}
		if (document.getElementById(key).value == "fir" && !Known.fire_arrows) {Check[document.getElementById(key).id] = "fire_arrows"; Location.fire_arrows = document.getElementById(key).id; document.getElementById("fire_arrows_location").innerHTML = "Fire Arrows -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.fire_arrows = true; if (!hinted && !peeked) {Game.fire_arrows = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Fire Arrows" + "<br />";} junkItem(document.getElementById(key)); continue;}
		if (document.getElementById(key).value == "len" && !Known.lens_of_truth) {Check[document.getElementById(key).id] = "lens_of_truth";Location.lens_of_truth = document.getElementById(key).id; document.getElementById("lens_of_truth_location").innerHTML = "Lens -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.lens_of_truth = true; if (!hinted && !peeked) {Game.lens_of_truth = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Lens" + "<br />";} junkItem(document.getElementById(key)); continue;}
		...
		if ((document.getElementById(key).value == "pre" || document.getElementById(key).value == "eye" || document.getElementById(key).value == "dro") && (!Known.prescription || !Known.claim_check)) {Check[document.getElementById(key).id] = "prescription";Location.prescription = document.getElementById(key).id; document.getElementById("trade_location").innerHTML = "Prescription -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.prescription = true; if (!hinted && !peeked) {Game.prescription = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Prescription" + "<br />";} junkItem(document.getElementById(key)); continue;}
		if (document.getElementById(key).value == "cla" && (!Known.prescription || !Known.claim_check)) {Check[document.getElementById(key).id] = "claim_check";Location.claim_check = document.getElementById(key).id; document.getElementById("trade_location").innerHTML = "Claim -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.claim_check = true; if (!hinted && !peeked) {Game.claim_check = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Claim Check" + "<br />";} junkItem(document.getElementById(key)); continue;}
		
		if (document.getElementById(key).value == "lig" && !Known.light_arrows) {Check[document.getElementById(key).id] = "light_arrows"; Location.light_arrows = document.getElementById(key).id; document.getElementById("light_arrows_location").innerHTML = "Light Arrows -> " + AreaNames[AreaNamesIndex] + ": " + Names[i]; Known.light_arrows = true; if (!hinted && !peeked) {Game.light_arrows = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {itext2 += Names[i - 1].split(': ')[1] + ":  Light Arrows" + "<br />";}junkItem(document.getElementById(key)); continue;}
...
function update_logic_info() {
	...
	for (var i = 0; i < Locations.length; i++) {
		...
		if (document.getElementById("skullSanity").value != "ALL" && document.getElementById("skullSanity").value != "DUNGEON" && (Locations[i].startsWith("gs_forest") || Locations[i].startsWith("gs_fire") || Locations[i].startsWith("gs_water") || Locations[i].startsWith("gs_spirit") || Locations[i].startsWith("gs_shadow") || Locations[i].startsWith("gs_ice") || Locations[i].startsWith("gs_well"))) {continue;}
		if (document.getElementById("skullSanity").value != "ALL" && Locations[i].startsWith("gs_") && (!Locations[i].startsWith("gs_forest") && !Locations[i].startsWith("gs_fire") && !Locations[i].startsWith("gs_water") && !Locations[i].startsWith("gs_spirit") && !Locations[i].startsWith("gs_shadow") && !Locations[i].startsWith("gs_ice") && !Locations[i].startsWith("gs_well"))) {continue;}
