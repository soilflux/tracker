...
function spawnInputs() {
	...
	if (document.getElementById("markAdultLocation").value.toLowerCase() == locationInputs[11].toLowerCase()) {Spawn.adult_gc_shop = true;} else {Spawn.adult_gc_shop = false;}
	if (document.getElementById("markAdultLocation").value.toLowerCase() == locationInputs[8].toLowerCase()) {Spawn.adult_nocturne = true;} else {Spawn.adult_nocturne = false;}
	if (document.getElementById("markAdultLocation").value.toLowerCase() == locationInputs[1].toLowerCase()) {Spawn.adult_fishing = true;} else {Spawn.adult_fishing = false;}
	if (document.getElementById("markAdultLocation").value.toLowerCase() == locationInputs[9].toLowerCase()) {Spawn.adult_meadow = true;} else {Spawn.adult_meadow = false;}
	if (document.getElementById("markAdultLocation").value.toLowerCase() == locationInputs[12].toLowerCase()) {Spawn.adult_zd_shop = true; Spawn.adult_zd = true;} else {Spawn.adult_zd_shop = false;}
	...
	if (document.getElementById("markAdultLocation").value.toLowerCase() == locationInputs[10].toLowerCase()) {Spawn.adult_ogc = true;} else {Spawn.adult_ogc = false;}
}
...
function update_logic_info() {
	if (document.getElementById("presets").value == "LESS_PROGRESSION") {document.getElementById("bosskeys").value = "REMOVE"; document.getElementById("shuffleOcarinas").value = "ON"; document.getElementById("ganonsBridge").value = "ALL_MED"; document.getElementById("closedDeku").value = "CLOSED"; document.getElementById("ganonBKSetting").value = "NONE";}
	if (document.getElementById("presets").value == "S3") {document.getElementById("bosskeys").value = "DUNGEON_ONLY"; document.getElementById("shuffleOcarinas").value = "OFF"; document.getElementById("ganonsBridge").value = "ALL_MED"; document.getElementById("closedDeku").value = "OPEN"; document.getElementById("ganonBKSetting").value = "NONE";}
	if (document.getElementById("presets").value == "SGL") {document.getElementById("bosskeys").value = "DUNGEON_ONLY"; document.getElementById("shuffleOcarinas").value = "OFF"; document.getElementById("ganonsBridge").value = "3_STONES"; document.getElementById("closedDeku").value = "OPEN"; document.getElementById("ganonBKSetting").value = "LACS";}
	if (document.getElementById("presets").value == "S4") {document.getElementById("bosskeys").value = "DUNGEON_ONLY"; document.getElementById("shuffleOcarinas").value = "ON"; document.getElementById("ganonsBridge").value = "2_MEDALS"; document.getElementById("closedDeku").value = "CLOSED"; document.getElementById("ganonBKSetting").value = "LACS";}
